...
<div class="container-fluid">
  <ul class="nav nav-pills nav-justified">
    ...
    <li><a data-toggle="pill" href="#menu4">Messages</a></li>
    <li><a data-toggle="pill" href="#menu1">Add Property</a></li>
    <li><a data-toggle="pill" href="#menu2">View Property</a></li>
    <li><a data-toggle="pill" href="#menu3">Update Property</a></li>
    <li><a data-toggle="pill" href="#menu6">Booked Property</a></li>
  </ul>
  ...
  <div class="tab-content">
    ...
    <div id="menu2" class="tab-pane fade">
      ...
      <div class="container-fluid">
        <input type="text" id="myInput" onkeyup="filterTable('myTable')" placeholder="Search..." title="Type in a name">
